...
export const NavigationBar: FC<NavigationBarProps> = ({ trigger }) => {
  ...
  return (
    <>
      <div className="md:w-24 w-full md:h-screen h-2 bg-white dark:bg-slate-950 border-r md:border-r-gray-400 md:dark:border-r-gray-800 py-5 fixed z-10 flex md:flex-col items-center justify-between bottom-0 md:top-0 left-0">
